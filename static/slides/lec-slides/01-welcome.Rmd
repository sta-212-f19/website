...
<i class="fa fa-calendar"></i> &nbsp; Wed 10:00-11:00a
...
<font size = "2"> Bob at Easle from  <a href = "https://en.wikipedia.org/wiki/File:Bob_at_Easel.jpg">Wikipedia</a></font>
---
...
bob <- read_csv("https://raw.githubusercontent.com/fivethirtyeight/data/master/bob-ross/elements-by-episode.csv")
...
- Change `TV` in the plot to a different `quantitative` variable. Look at the **quantitative variables** section to see the exact way the variables are named. Knit again. And voila, your first data viz!
...
- Pratice posting here - post a fun fact about your self, respond with an emoji `r emo::ji("+1")`, etc
