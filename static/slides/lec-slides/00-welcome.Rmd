...
Go to [bit.ly/sta-112-f19-rstudio-join](http://bit.ly/sta-112-f19-rstudio-join), and log in with your GitHub credentials.
...
- Course content, logistics, etc. discussion via GitHub on the [sta-112-f19/community](https://github.com/sta-112-f19/community) repository. Note that this is a public discussion forum, which means others outside of the course can stumble upon it and help you as well.
