...
11. Rank each of the following principles from the [Elements and Principles of Data Analysis](https://arxiv.org/pdf/1903.07639.pdf) article for this data analysis from 1 to 10 (for example, for the first one, I would say that this data set matched the analysis requested, so the data matching was 10):
