...
4. Using the `single_candy_rankings`, create a visualization to describe the relationship between `sugarpercent` and `winpercent` (where `winpercent` is on the y-axis). Describe the relationship that you see.

5. We are interested in fitting a simple linear regression of the form:
...
6. What is $\hat{\beta}_0$? What is $\hat{\beta}_1$? Interpret these results in _words_. 

7. Calculate the residuals for the model fit in Exercise 5. Create a scatterplot of the residuals by $\hat{y}$, the predicted outcome, `winpercent`. Do the conditions of linearity and constant variance seem to hold?
...
8. Plot the residuals using a histogram with `binwidth = 9` to observe whether they follow a bell-shaped distribution. Comment on what you see.

9. Calculate the regression standard error for the model created in Exercise 5. How do you interpret this result?
...
Exercises 1-2                   | 10 pts
Exercises 3-9                   | 70 pts
Exercise 10                   | 5 pts
