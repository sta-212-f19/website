...
6. Construct a scatterplot examining the relationship between the tree height in 1996 and the height in 1997. Comment on what you see. How does this compare to the results seen in 5?
...
9. Choose a model (between the two fit in 7 and 8) that best predicts the tree height in 1997. Explain in words what this model shows us.
